            ...
            <div class="px-4 sm:px-6 lg:px-8 py-6">
              <div class="flex flex-col md:flex-row items-center justify-between">
                ...
                <div class="flex items-center space-x-6 mt-4 md:mt-0">
                  <a href="#" class="text-sm text-gray-500 hover:text-primary-600 transition">Documentation</a>
                  <a href="#" class="text-sm text-gray-500 hover:text-primary-600 transition">Support</a>
                  <a href="#" class="text-sm text-gray-500 hover:text-primary-600 transition">Privacy Policy</a>
                  <a href="#" class="text-sm text-gray-500 hover:text-primary-600 transition">Terms of Service</a>
                </div>
              </div>
