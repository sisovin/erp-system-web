...
<div class="min-h-screen flex items-center justify-center bg-gradient-to-br from-primary-50 via-white to-blue-50 px-4 sm:px-6 lg:px-8 py-12">
  <div class="max-w-6xl w-full space-y-8">
    ...
    <div class="text-center">
      ...
      <p class="text-sm text-gray-600">Start your journey today</p>
    </div>
    ...
    <!-- Two Column Registration Card -->
    <div class="card max-w-4xl mx-auto">
      <h3 class="text-2xl font-bold text-gray-900 mb-8 text-center">Create your account</h3>
      ...
      <div class="relative grid grid-cols-1 md:grid-cols-2 gap-8 md:gap-12">
        ...
        <!-- Left Column: Social Media Sign-up -->
        <div class="space-y-4">
          <div class="mb-6">
            <h4 class="text-lg font-semibold text-gray-900 mb-2">Social Sign-up</h4>
            <p class="text-sm text-gray-600">Quick registration with your account</p>
          </div>
          
          <div class="space-y-3">
            <!-- Google -->
            <button type="button" onclick="socialRegister('google')" class="w-full flex items-center justify-center px-4 py-3 border border-gray-300 rounded-lg shadow-sm bg-white hover:bg-gray-50 transition-all duration-200 hover:shadow-md group">
            ...
            <!-- Microsoft -->
            <button type="button" onclick="socialRegister('microsoft')" class="w-full flex items-center justify-center px-4 py-3 border border-gray-300 rounded-lg shadow-sm bg-white hover:bg-gray-50 transition-all duration-200 hover:shadow-md group">
            ...
            <!-- GitHub -->
            <button type="button" onclick="socialRegister('github')" class="w-full flex items-center justify-center px-4 py-3 border border-gray-300 rounded-lg shadow-sm bg-white hover:bg-gray-50 transition-all duration-200 hover:shadow-md group">
              ...
              <span class="text-sm font-medium text-gray-700 group-hover:text-gray-900">Sign up with GitHub</span>
            </button>

            <!-- LinkedIn -->
            <button type="button" onclick="socialRegister('linkedin')" class="w-full flex items-center justify-center px-4 py-3 border border-gray-300 rounded-lg shadow-sm bg-white hover:bg-gray-50 transition-all duration-200 hover:shadow-md group">
              ...
              <span class="text-sm font-medium text-gray-700 group-hover:text-gray-900">Sign up with LinkedIn</span>
            </button>
          </div>

          <!-- Benefits -->
          <div class="mt-8 pt-6 border-t border-gray-200">
            <p class="text-xs text-gray-500 mb-3">Why choose PEANECH ERP?</p>
            <ul class="space-y-2 text-xs text-gray-600">
              ...
              <li class="flex items-start">
                <i data-feather="check" class="w-4 h-4 text-green-600 mr-2 mt-0.5 stroke-current flex-shrink-0"></i>
                <span>All features included in trial period</span>
              </li>
              <li class="flex items-start">
                <i data-feather="check" class="w-4 h-4 text-green-600 mr-2 mt-0.5 stroke-current flex-shrink-0"></i>
                <span>24/7 customer support & onboarding</span>
              </li>
            </ul>
          </div>
        </div>
        ...
        <div class="md:col-start-2 space-y-4">
          <div class="mb-6">
            <h4 class="text-lg font-semibold text-gray-900 mb-2">Email Sign-up</h4>
            <p class="text-sm text-gray-600">Create account with your email</p>
          </div>
          ...
          <form method="post" action="/register" class="space-y-4">
            ...
            <div>
              ...
              <div class="relative">
                <div class="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">
                  <i data-feather="user" class="w-5 h-5 text-gray-400 stroke-current"></i>
                </div>
                <input 
                  type="text" 
                  id="name" 
            ...
            <div class="flex items-start">
              ...
              <label for="terms" class="ml-2 text-sm text-gray-600">
                I agree to the 
                <a href="/terms" class="font-medium text-primary-600 hover:text-primary-700">Terms of Service</a>
                and 
                <a href="/privacy" class="font-medium text-primary-600 hover:text-primary-700">Privacy Policy</a>
              </label>
            </div>
      ...
      <div class="grid grid-cols-1 sm:grid-cols-3 gap-6">
        <div class="text-center">
          <div class="w-14 h-14 bg-white rounded-xl shadow-sm flex items-center justify-center mx-auto mb-3 transition hover:shadow-md">
            <i data-feather="users" class="w-7 h-7 text-primary-600 stroke-current"></i>
          </div>
          <h5 class="text-sm font-semibold text-gray-900 mb-1">10,000+ Users</h5>
          <p class="text-xs text-gray-600">Join thousands of satisfied customers</p>
        </div>
        <div class="text-center">
          <div class="w-14 h-14 bg-white rounded-xl shadow-sm flex items-center justify-center mx-auto mb-3 transition hover:shadow-md">
            <i data-feather="award" class="w-7 h-7 text-primary-600 stroke-current"></i>
          </div>
          <h5 class="text-sm font-semibold text-gray-900 mb-1">Award Winning</h5>
          <p class="text-xs text-gray-600">Recognized for excellence & innovation</p>
        </div>
        <div class="text-center">
          <div class="w-14 h-14 bg-white rounded-xl shadow-sm flex items-center justify-center mx-auto mb-3 transition hover:shadow-md">
            <i data-feather="headphones" class="w-7 h-7 text-primary-600 stroke-current"></i>
          </div>
          <h5 class="text-sm font-semibold text-gray-900 mb-1">24/7 Support</h5>
          <p class="text-xs text-gray-600">Expert help whenever you need it</p>
        </div>
      </div>
    </div>
...
function socialRegister(provider) {
  ...
  alert(`Social registration with ${provider} will be implemented here.\n\nThis would typically redirect to:\n/auth/${provider}/register`);
